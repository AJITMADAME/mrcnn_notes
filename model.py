 ...
 #           self.keras_model.add_loss(loss)
  ...
  #          self.keras_model.metrics_names.append(name)
   ...
   #         self.keras_model.add_metric(loss, name=name, aggregation='mean')
    ...
    def compile(self, learning_rate, momentum, gradient_clip_norm):
        """Gets the model ready for training. Adds losses, regularization, and
        metrics. Then calls the Keras compile() function.
        """
        # Optimizer object
        optimizer = keras.optimizers.SGD(
            learning_rate=learning_rate, momentum=momentum, clipnorm=gradient_clip_norm)
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers, gradient_clip_norm,
        ...
        self.compile(learning_rate, self.config.LEARNING_MOMENTUM, gradient_clip_norm)
